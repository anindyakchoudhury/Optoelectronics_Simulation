...
% clearvars;
% close all;
% % Plot Spectral analysis and find peak wavelength for White LED

% % Define the list of files to process
% files = {'WHITE_9.txt', 'WHITE_10.txt', 'WHITE_11.txt', 'WHITE_12.txt', 'WHITE_13.txt'};
...
% title('Spectral Analysis of White LED');
...
% save('peak_data_white.mat', 'peak_intensity', 'peak_wavelength', 'linewidth');
...
for i = 1:length(files)
    ...
    plot(lambda, Intensity, 'Color', colors{i}, 'LineWidth', 2, ...
         'DisplayName', sprintf('White LED at %dV', i+8));
end
...
saveas(gcf, 'C:\SPB_Data\EEE460_Jan2024_byakc\EXP9_BYAKC\reportprepare\Spectra_white.png');