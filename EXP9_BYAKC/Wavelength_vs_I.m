...
figure('Color', 'white');
plot(I, peak_wavelength, 'Color', [0.929, 0.694, 0.125], 'LineWidth', 2, ...
     'DisplayName', 'Yellow');
hold on
...
plot(I, peak_wavelength, 'Color', [0.180, 0.545, 0.341], 'LineWidth', 2, ...
     'DisplayName', 'Green');
...
plot(I, peak_wavelength, 'Color', [0.267, 0.447, 0.769], 'LineWidth', 2, ...
     'DisplayName', 'White');
...
plot(I, peak_wavelength, 'Color', [0.850, 0.325, 0.098], 'LineWidth', 2, ...
     'DisplayName', 'Red');
...
ylabel('Wavelength (nm)', ...
       ...
       'FontWeight', 'bold', ...
       'Interpreter', 'latex');
title('Peak Wavelength vs Current of LED', ...
      'FontSize', 14, ...
      'FontWeight', 'bold', ...
      'Interpreter', 'latex');
...
box on;
saveas(gcf, 'C:\SPB_Data\EEE460_Jan2024_byakc\EXP9_BYAKC\reportprepare\WavelengthvsI.png');