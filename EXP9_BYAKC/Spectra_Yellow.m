...
% clearvars;
% close all;
% % Plot Spectral analysis and find peak wavelength for Yellow LED

% % Define the list of files to process
% files = {'YELLOW_9.txt', 'YELLOW_10.txt', 'YELLOW_11.txt', 'YELLOW_12.txt', 'YELLOW_13.txt'};
...
% title('Spectral Analysis of Yellow LED');
...
% save('peak_data_yellow.mat', 'peak_intensity', 'peak_wavelength', 'linewidth');
...
for i = 1:length(files)
    ...
    plot(lambda, Intensity, 'Color', colors{i}, 'LineWidth', 2, ...
         'DisplayName', sprintf('Yellow LED at %dV', i+8));
end
...
% Save the peak data in a MATLAB data file
save('peak_data_yellow.mat', 'peak_intensity', 'peak_wavelength', 'linewidth');
saveas(gcf, 'C:\SPB_Data\EEE460_Jan2024_byakc\EXP9_BYAKC\reportprepare\Spectra_yellow.png');